...
##description<< Compute standardized tree metrics from external inventory data and, when requested,
### derive stand-level summaries or volume variables within the external basifoR workflow. Process external tree data through a unified workflow that standardizes measurements, computes missing dendrometric variables, optionally derives volume outputs, and returns either tree-level records or grouped stand-level summaries.
